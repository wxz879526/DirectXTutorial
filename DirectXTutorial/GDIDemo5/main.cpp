...
#define WINDOW_TITLE L"GDIDemo5 ³ÌÐòºËÐÄ¿ò¼Ü"
#define WINDOW_CLASS_NAME L"My_CLASS_GDI_DEMO5"
...
VOID Game_Paint(HWND hWnd)
{
	...
	TransparentBlt(g_hdc, 0, WINDOW_HEIGHT - 650, 535, 650, g_memDC, 0, 0, 535, 650, RGB(0, 0, 0));

	SelectObject(g_memDC, g_hSprite2);
	TransparentBlt(g_hdc, 500, WINDOW_HEIGHT - 650, 506, 650, g_memDC, 0, 0, 506, 650, RGB(0, 0, 0));
}
